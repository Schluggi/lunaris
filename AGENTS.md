...
Typical MQTT topics: `…/button/prime/set`, `…/button/vibrate_left|vibrate_right/set`, `…/binary_sensor/priming/state`, `…/sensor/cover_temperature_left|right/state`, `…/sensor/heatsink_temp/state`, `…/sensor/target_temperature_left|right/state`, `…/climate/…`, `…/switch/startup_led/set|state`, `…/result`.
